...
namespace {
    ...
    class Input extends \Illuminate\Support\Facades\Input{
         ...
         * Gets the Session.
         *
         * @return \Symfony\Component\HttpFoundation\SessionInterface|null The sessions
         * @api 
         * @static 
         */
        public static function getSession(){
    ...
    class Session extends \Illuminate\Support\Facades\Session{
        ...
        /**
         * Starts the sessions storage.
         *
         * @return bool True if sessions started.
         * @throws \RuntimeException If sessions fails to start.
         * @api 
         * @static 
         */
         ...
         *
         * @return mixed The sessions name.
         * @api 
         * @static 
         */
        public static function getName(){
        ...
        /**
         * Invalidates the current sessions.
         * 
         * Clears all sessions attributes and flashes and regenerates the
         * sessions and deletes the old sessions from persistence.
         *
         * @param int $lifetime Sets the cookie lifetime for the sessions cookie. A null value
         *                      will leave the system settings unchanged, 0 sets the cookie
         *                      to expire with browser sessions. Time is in seconds, and is
         *                      not a Unix timestamp.
         * @return bool True if sessions invalidated, false if error.
         * @api 
         * @static 
         */
        ...
        /**
         * Migrates the current sessions to a new sessions id while maintaining all
         * sessions attributes.
         *
         * @param bool $destroy Whether to delete the old sessions or leave it to garbage collection.
         * @param int $lifetime Sets the cookie lifetime for the sessions cookie. A null value
         *                       will leave the system settings unchanged, 0 sets the cookie
         *                       to expire with browser sessions. Time is in seconds, and is
         *                       not a Unix timestamp.
         * @return bool True if sessions migrated, false if error.
         * @api 
         * @static 
         */
        ...
        /**
         * Force the sessions to be saved and closed.
         * 
         * This method is generally not required for real sessions as
         * the sessions will be automatically saved at the end of
         * code execution.
         *
         * @static 
         */
        ...
        /**
         * Checks if the sessions was started.
         *
         * @return bool 
         * @static 
         */
        ...
        /**
         * Registers a SessionBagInterface with the sessions.
         *
